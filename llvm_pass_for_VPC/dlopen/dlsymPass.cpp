  ...
  struct PrintfFormatReinterpret : public ModulePass {
    ...
    bool runOnModule(Module &M) {
                ...
                for (Module::iterator mi = M.begin(); mi != M.end(); ++mi) {
                    ...
                    std::regex extDlopen_pattern("ext_[0-9a-z]*_dlopen");
                    std::regex extDlsym_pattern("ext_[0-9a-z]*_dlsym");
                    ...
                    //查找待匹配函数
                    if (std::regex_match(fname,extDlsym_pattern)) {
                                ...
                                if(stop_pre_find_flag==1)
                                  {
                                    ...
                                    errs() << "the target function of dlsym is :"<< "\n";
                                    errs() << temNode.format<< "\n";
